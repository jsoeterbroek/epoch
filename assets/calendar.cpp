...
#include <cmath>
#include <array>
#include "astro.h"  // Ensure this points to your correct astro header
...
/* example
double jd = calendar::gregorian_to_jd(2025, 4, 30);
int weekday = jd_to_weekday(jd);
Serial.print("Day of week: ");
Serial.println(day_of_week_name(weekday));
*/
