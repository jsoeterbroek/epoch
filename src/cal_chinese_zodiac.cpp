...
std::string chinese_day_stem_branch(double jd) {
  ...
  static const std::array<const char *, 10> STEMS = {"Jia", "Yi", "Bing", "Ding", "Wu", "Ji", "Geng", "Xin", "Ren", "Gui"};
  static const std::array<const char *, 12> BRANCHES = {"Zi", "Chou", "Yin", "Mao", "Chen", "Si", "Wu", "Wei", "Shen", "You", "Xu", "Hai"};
...
std::string chinese_lunar_month_name(double jd) {
  ...
  static const std::array<const char *, 12> LUNAR_MONTHS = {"Zhengyue", "Eryue", "Sanyue", "Siyue",  "Wuyue",    "Liuyue",
...
std::string format_chinese_zodiac_date_month(double jd) {
  static const std::array<const char *, 12> CHINESE_SOLAR_MONTHS = {"Zhengyue", "Eryue", "Sanyue", "Siyue",  "Wuyue",    "Liuyue",
                                                                    "Qiyue",    "Bayue", "Jiuyue", "Shiyue", "Shiyiyue", "Shieryue"};
