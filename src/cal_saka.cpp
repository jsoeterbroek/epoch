...
const char *saka_months_sa[12] = {"Chaitra", "Vaishakha", "Jyeshtha",   "Ashadha", "Shravana", "Bhadrapada",
                                  "Ashvina", "Kartika",   "Agrahayana", "Pausha",  "Magha",    "Phalguna"};

const char *saka_months_hi[12] = {"चैत्र", "वैशाख", "ज्येष्ठ", "आषाढ़", "श्रावण", "भाद्रपद", "आश्विन", "कार्तिक", "अग्रहायण", "पौष", "माघ", "फाल्गुन"};

const char *weekday_names_sa[7] = {"Somavara", "Mangalavara", "Budhavara", "Guruvara", "Shukravara", "Shanivara", "Ravivara"};

const char *weekday_names_hi[7] = {"सोमवार", "मंगलवार", "बुधवार", "गुरुवार", "शुक्रवार", "शनिवार", "रविवार"};
...
std::array<int, 3> jd_to_saka(double jd) {
  ...
  int saka_new_year = static_cast<int>(gregorian_to_jd(gy, start_month, start_day) - gregorian_to_jd(gy, 1, 1)) + 1;
...
double saka_to_jd(int year, int month, int day) {
  ...
  // Month lengths
  int month_lengths[12] = {30, 31, 31, 31, 31, 31, 30, 30, 30, 30, 30, 30};
