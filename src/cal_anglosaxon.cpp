...
const char* anglosaxon_month_name(int month) {
    static const char* names[] = {
        "Aefterra Geola", "Sol-monath", "Hreth-monath", "Easter-monath", "Thrimilce-monath", "Aerra Litha",
...
const char* anglosaxon_month_desc(int month) {
    static const char* desc[] = {
        "After Yule", "Mud month", "Month of Wildness", "Month of Dawn", "Month of Three Milkings", "Before Midsummer",
        "After Midsummer", "Weed month", "Holy Month", "Winter full moon", "Blood Month", "Before Yule"
    };
    return desc[month - 1];
}
