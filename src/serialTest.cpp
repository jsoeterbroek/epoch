...
void serialTest(void) {
  ...
  Serial.println(format_mayan_date_day(jd).c_str());
  Serial.println(format_mayan_date_month(jd).c_str());
  delay(_delay);
  Serial.println("-----------------------------------");
  ...
  Serial.println(format_zoroastrian_date_roj(jd, ZoroastrianCalendarVariant::Fasli));
  Serial.println(format_zoroastrian_date_mah(jd, ZoroastrianCalendarVariant::Fasli));
