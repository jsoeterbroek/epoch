...
const char* const MONTH_NAMES[12] = {
    "Farvardin", "Ardibehesht", "Khordad", "Tir", "Amardad", "Shahrevar",
    "Meher", "Avan", "Adar", "Dae", "Bahman", "Aspandarmad"
};

const char* const ROJ_NAMES[30] = {
    "Hormazd", "Bahman", "Ardibehesht", "Shahrevar", "Spandarmad", "Khordad", "Amardad",
    "Dae-pa-Adar", "Adar", "Aban", "Khorshed", "Mah", "Tir", "Gosh", "Dae-pa-Meher",
    "Meher", "Srosh", "Rashne", "Fravardin", "Behram", "Ram", "Govad", "Dae-pa-Din",
    "Din", "Ashishvangh", "Ashtad", "Asman", "Zamyad", "Marespand", "Aneran"
};
...
std::array<int, 3> jd_to_zoroastrian(double jd, ZoroastrianCalendarVariant variant) {
    ...
    switch (variant) {
        case ZoroastrianCalendarVariant::Shenshai:
            nowruz_jd = find_nowruz_jd(year, jd, SHENSHAI_NOWRUZ, sizeof(SHENSHAI_NOWRUZ) / sizeof(NowruzEntry));
            break;
        case ZoroastrianCalendarVariant::Kadmi:
            nowruz_jd = find_nowruz_jd(year, jd, KADMI_NOWRUZ, sizeof(KADMI_NOWRUZ) / sizeof(NowruzEntry));
            break;
        case ZoroastrianCalendarVariant::Fasli:
            nowruz_jd = find_nowruz_jd(year, jd, FASLI_NOWRUZ, sizeof(FASLI_NOWRUZ) / sizeof(NowruzEntry));
            break;
    }
