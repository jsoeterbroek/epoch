...
static const char *EGYPTIAN_MONTHS[13] = {"Thoth",     "Phaophi", "Athyr", "Koiak",  "Tybi",   "Mechir",    "Phamenoth",
...
std::string format_egyptian_date_day(double jd) {
  ...
  static const char *lunar_day_names[30] = {// "psḏntyw", "dnit", "ḥꜣw", "ḥꜣw-nfr", "dḥwty", "sḫt",
...
std::string format_egyptian_date_weekday(double jd) {
  ...
  static const char *DECAN_DAYS[10] = {"Day 1 (Decan)", "Day 2", "Day 3", "Day 4", "Day 5", "Day 6", "Day 7", "Day 8", "Day 9", "Day 10"};
