...
TEST_CASE("Mariner 4 flyby date conversion") {
  double jd1 = gregorian_to_jd_astronomical(1965, 7, 15);
  int darian_year, darian_month, sol;
  jd_to_darian(jd1, darian_year, darian_month, sol);
  std::cout << "JD: " << jd1 << "\n";
  std::cout << "Darian: year=" << darian_year << ", month=" << darian_month << ", sol=" << sol << "\n";
  std::cout << "Formatted: " << format_darian_date_full(darian_year, darian_month, sol, DarianWeekStyle::Latin, DarianMonthStyle::Zodiac) << "\n";
...
TEST_CASE("Perseverance landing date conversion") {
  double jd2 = gregorian_to_jd_astronomical(2021, 2, 18);
  int darian_year, darian_month, sol;
